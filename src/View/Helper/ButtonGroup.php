...
class ButtonGroup extends AbstractHelper {
    ...
    public function render(array $aButtons, array $aButtonGroupOptions = null) {
        ...
        return sprintf(
                ...
                //Buttons
                $this->renderButtons(
                        $aButtons, strpos($aButtonGroupOptions['attributes']['class'], 'btn-group-justified') !== false
                )
        );
    }
    ...
    public function getFormElementHelper() {
        if ($this->formElementHelper instanceof FormElement) {
        ...
        return $this->formElementHelper = new FormElement();
    }
