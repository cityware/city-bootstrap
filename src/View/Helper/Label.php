...
class Label extends AbstractHelper {
     ...
     * @return string|\Cityware\Bootstrap\View\Helper\Alert
     */
    ...
    public function render($sLabelMessage, $aLabelAttributes = 'label-default') {
        ...
        return sprintf(
                self::$labelFormat, isset($aLabelAttributes['tagName']) ? $aLabelAttributes['tagName'] : $this->tagName, $this->createAttributesString($aLabelAttributes), $sLabelMessage
        );
    }
